...
This vignette demonstrates how to use _conquestr_ to document data, report on the quality of data, clean data, and construct item bundles or derived variables based on several variables.
